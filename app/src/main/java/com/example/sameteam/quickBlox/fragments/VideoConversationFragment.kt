...
import com.example.sameteam.quickBlox.adapter.OpponentsFromCallAdapter
...
class VideoConversationFragment : BaseConversationFragment(), Serializable,
    ...
    override fun initViews(view: View?) {
        ...
        if (!isPeerToPeerCall) {
            ...
            val context = requireActivity()
            recyclerView.addItemDecoration(DividerItemDecoration(context, R.dimen.scale_1dp))
//            recyclerView.setHasFixedSize(true)
    ...
    private fun setGrid(columnsCount: Int) {
        ...
        val itemMargin = resources.getDimension(R.dimen.scale_1dp)
        ...
        gridWidth?.let {
            ...
            opponentsAdapter = OpponentsFromCallAdapter(requireContext(), this, opponents, cellSizeWidth,
                    resources.getDimension(R.dimen.scale_135dp).toInt())
        ...
        conversationFragmentCallback?.onSwitchCamera(object : CameraVideoCapturer.CameraSwitchHandler {
            override fun onCameraSwitchDone(b: Boolean) {
                ...
                if (item != null) {
                    ...
                    optionsMenu?.findItem(R.id.camera_switch)?.setIcon(R.drawable.ic_rotate_camera)
                }
    ...
    private fun updateSwitchCameraIcon(item: MenuItem) {
        if (isCurrentCameraFront) {
            ...
            item.setIcon(R.drawable.ic_rotate_camera)
        } else {
    ...
    private fun setRecyclerViewVisibleState() {
        ...
        params.height = resources.getDimension(R.dimen.scale_135dp).toInt()
...
//    }
    ...
    internal inner class LocalViewOnClickListener : View.OnClickListener {
        ...
        private fun shiftMarginListOpponents() {
            ...
            params.setMargins(0, 0, 0, resources.getDimension(R.dimen.scale_16dp).toInt())
