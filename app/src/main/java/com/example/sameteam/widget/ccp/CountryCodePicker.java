package com.example.sameteam.widget.ccp;
...
public class CountryCodePicker extends RelativeLayout {
    ...
    private static final int TEXT_GRAVITY_RIGHT = 1;
    ...
    private void applyCustomProperty(AttributeSet attrs) {
        ...
        try {
            ...
            if (isInEditMode()) {
                ...
                borderFlagColor = a.getColor(R.styleable.CountryCodePicker_ccp_flagBorderColor, Color.TRANSPARENT);
            }
